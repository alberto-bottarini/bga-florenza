...
$this->florenzaCards = array(
	...
	"CAMBIAVALUTE" => array(
		...
		"description" => clienttranslate('You get an income of 50 money'),
		"class" => "BOTTEGA",
		"cost" => array(
			"wood" => 1,
			"gold" => 1
	...
	"MINIERA" => array(
		...
		"description" => clienttranslate('You get an income of a gold and 100 money'),
		"class" => "BOTTEGA",
		"cost" => array(
			"wood" => 1,
			"metal" => 1,
	...
	"FONDERIA" => array(
		...
		"description" => clienttranslate('You get an income of a metal and 100 money'),
		"class" => "BOTTEGA",
		"cost" => array(
			"wood" => 1,
			"marble" => 1,
	...
	"SEGHERIA" => array(
		...
		"class" => "BOTTEGA",
		"description" => clienttranslate('You get an income of a wood and 100 money'),
		"cost" => array(
			"metal" => 1,
			"marble" => 1,
			"money" => 50
	...
	"CAVA" => array(
		...
		"titleTr" => self::_("Cava"),
		"description" => clienttranslate('You get an income of a marble and 100 money'),
		"class" => "BOTTEGA",
		"cost" => array(
			"metal" => 1,
			"wood" => 1,
	...
	"SETAIUOLO" => array(
		...
		"description" => clienttranslate('You get an income of a fabric and 100 money'),
		"class" => "BOTTEGA",
		"cost" => array(
			"spice" => 1,
			"wood" => 1,
	...
	"MERCATANTE" => array(
		...
		"description" => clienttranslate('You get an income of a spice and 100 money'),
		"class" => "BOTTEGA",
		"cost" => array(
			"gold" => 1,
			"fabric" => 1,
